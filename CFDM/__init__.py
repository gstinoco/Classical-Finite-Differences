...
if __name__ == "__main__":
    pass                                                                                        # Package initializers have no standalone execution behavior.
=========================================================================================
CFDM Module Initialization
=========================================================================================

This module initializes the CFDM package, exposing the numerical solvers for the
Poisson, Diffusion, Advection, and Advection-Diffusion Equations.
