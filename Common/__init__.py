...
This module initializes the Common package, providing access to generic plotting 
tools, error metrics computation, and shared analytical resources across the project.
